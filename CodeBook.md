...
# Code book
The original dataset is generated by the script run_analysis.R. That combines all the observations in total 10,299. Each of 561 variables has abovementioned measurement values and the rest of the variables label the volunteer participants and 6 activities. The features of original dataset are described in the following section.
The DataSet.csv is a dataset created based on the original with average of each variable for each activity and each subject.
